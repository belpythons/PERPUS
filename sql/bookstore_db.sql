-- ================================================================
-- BELVA BOOKSTORE DATABASE - Complete SQL Script
-- ================================================================
-- Description: Complete database schema and sample data for Belva Bookstore
-- Version: 1.0
-- Created: July 2025
-- Author: Belva Team
-- 
...
(1, 'Fiction', 'Novel dan cerita fiksi yang menghibur dan menginspirasi', '2025-07-18 10:00:00'),
...
-- Dumping data for table `books` with Google Images URLs
...
(19, 'Educated', 'Tara Westover', 2, 'Memoir tentang kekuatan pendidikan mengubah hidup', 175000.00, 25, 'https://images-na.ssl-images-amazon.com/images/P/0399590501.01.L.jpg', '2025-07-18 12:05:00'),
...
-- Education Books
(23, 'Make It Stick', 'Peter C. Brown', 7, 'Ilmu pembelajaran yang efektif berdasarkan riset kognitif', 155000.00, 15, 'https://images-na.ssl-images-amazon.com/images/P/0674729013.01.L.jpg', '2025-07-18 12:25:00'),
...
(2, 3, 1, 4, 'Bagus banget, bikin nangis juga. Recommended untuk yang suka novel Indonesia.', '2025-07-18 16:45:00'),
...
(5, 3, 14, 4, 'Buku yang mengubah mindset saya tentang uang dan investasi. Sangat recommended!', '2025-07-18 19:30:00'),
...
(2, 3, 160000.00, 'completed', '2025-07-18 17:30:00'),
...
(7, 3, 245000.00, 'completed', '2025-07-19 16:20:00'),
...
-- Transaction 1 (User 2): Laskar Pelangi + Clean Code + JavaScript
(1, 1, 1, 1, 85000.00),
(2, 1, 6, 1, 350000.00),
-- Transaction 2 (User 3): Atomic Habits + Ayat-Ayat Cinta
(3, 2, 17, 1, 160000.00),
-- Transaction 3 (User 4): Steve Jobs + Elon Musk + Steve Jobs
(4, 3, 11, 1, 250000.00),
(5, 3, 12, 1, 280000.00),
-- Transaction 4 (User 2): JavaScript Book
(6, 4, 7, 1, 275000.00),
-- Transaction 5 (User 5): Sapiens + Educated
(7, 5, 18, 1, 195000.00),
(8, 5, 19, 1, 175000.00),
-- Transaction 6 (User 6): Laravel + Laravel
(9, 6, 8, 2, 150000.00),
-- Transaction 7 (User 3): The Blue Zones + Dilan 1990
(10, 7, 21, 1, 165000.00),
(11, 7, 3, 1, 65000.00),
-- Transaction 8 (User 4): Atomic Habits
(12, 8, 17, 1, 160000.00),
-- Transaction 9 (User 2): The Power of Now
(13, 9, 25, 1, 125000.00),
-- Transaction 10 (User 5): Elon Musk
...
(6, 3, 'register', 'New user registered: Sari Melati', '2025-07-18 12:45:00'),
(7, 3, 'login', 'User logged in', '2025-07-18 16:30:00'),
(8, 3, 'purchase', 'Purchased book: Atomic Habits', '2025-07-18 17:30:00'),
...
(20, 3, 'login', 'User logged in', '2025-07-19 15:50:00'),
(21, 3, 'purchase', 'Purchased books: The Blue Zones, Dilan 1990', '2025-07-19 16:20:00'),
...
(30, 3, 'review', 'Added review for Rich Dad Poor Dad', '2025-07-19 12:30:00'),
...
(34, 3, 'profile_update', 'Updated profile information', '2025-07-19 20:30:00'),
...
-- Add more user activities for comprehensive testing
...
(3, 'browse', 'Viewed book details: Laskar Pelangi', '2025-07-18 16:00:00'),
