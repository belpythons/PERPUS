...
if ($selected_category) {
    $stmt = $pdo->prepare("SELECT b.*, c.name as category_name FROM books b 
                           ...
                           WHERE b.category_id = ? ORDER BY b.created_at DESC");
...
<head>
    ...
    <title>Categories - Belva Digital Library</title>
...
<body>
        ...
        <section class="page-header">
            <div class="container">
                <div class="text-center">
                    ...
                    <p class="page-subtitle">Explore books by category and find exactly what you're looking for</p>
                </div>
            </div>
        </section>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="category-card">
                                <div class="category-icon-container">
                                    <i class="<?= $category_icons[$category['name']] ?? 'fas fa-book' ?> category-icon"></i>
                                </div>
                                <div class="category-body text-center">
                                    <h5 class="category-title"><?= htmlspecialchars($category['name']) ?></h5>
                                    <p class="category-description"><?= htmlspecialchars($category['description']) ?></p>
                                    <a href="categories.php?category=<?= $category['id'] ?>" class="btn btn-primary">
                                        <i class="fas fa-arrow-right me-2"></i>Explore Books
                                    </a>
                                </div>
                            </div>
                        </div>
    ...
    <?php else: ?>
        ...
        <section class="page-header">
            <div class="container">
                <div class="text-center">
                    <h1 class="page-title"><?= htmlspecialchars($category_name) ?> Books</h1>
                    <p class="page-subtitle">Discover amazing <?= strtolower(htmlspecialchars($category_name)) ?> books in our collection</p>
                </div>
            </div>
        </section>
        ...
        <div class="container">
            ...
            <div class="mb-4">
                <p class="text-muted">
                    <i class="fas fa-book-open me-2"></i>
                    Found <?= count($books) ?> book<?= count($books) != 1 ? 's' : '' ?> in <?= htmlspecialchars($category_name) ?> category
                </p>
            </div>
                ...
                <?php if (empty($books)): ?>
                    <div class="col-12">
                        <div class="text-center py-5">
                            ...
                            <p class="text-muted">Check back soon for new additions to our <?= htmlspecialchars($category_name) ?> collection</p>
